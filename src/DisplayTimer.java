...
public class DisplayTimer extends JDialog {
	...
	private void jbInit() throws Exception {
		...
		colonLabel.setLocation(0, (int) (Toolkit.getDefaultToolkit()
				.getScreenSize().getHeight() / 3 + this.getHeight() / 3));
		...
		minsLabel.setLocation(0, (int) (Toolkit.getDefaultToolkit()
				.getScreenSize().getHeight() / 3 + this.getHeight() / 3));
		...
		secsLabel
				.setLocation(this.getWidth() / 2 + 50,
						(int) (Toolkit.getDefaultToolkit().getScreenSize()
								.getHeight() / 3 + this.getHeight() / 3));
		...
		pauseButton.setBounds(new Rectangle(0, 0, 80, 80));
		...
		this.getContentPane().add(pauseButton, null);

		this.addMouseListener(new DisplayTimer_this_mouseAdapter(this));
		this.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
		this.addKeyListener(new DisplayTimer_this_keyAdapter(this));
		this.setModal(true);
		this.addWindowListener(new DisplayTimer_this_windowAdapter(this));
		this.getContentPane().setLayout(null);
		this.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
	...
	private void pause()  {
		paused = !paused;
		if (!paused) {
			oldCount = (int) new Date().getTime();
			pauseButton.setIcon(new ImageIcon(getClass().getResource("images/pause.png")));
		} else {
			pauseButton.setIcon(new ImageIcon(getClass().getResource("images/play.png")));
		}
	}
				...
				if (AudioSystem.isLineSupported(clipInfo)) {
					...
					if (loop)
						DisplayTimer.newClip
								.loop(DisplayTimer.newClip.LOOP_CONTINUOUSLY);
					else
